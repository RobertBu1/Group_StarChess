...
class Pawn {
  ...
  void move() { // write logic for how a pawn can move, figure out how to choose
                // a piece
    if (startingPosition) {
      if (bottom) {
...
public:
  RegularGame(int playerCount) {
    ...
    if ((rand() % 1) == 1 || players == 1) { // white is bottom
      ...
      string tempArray[64] = {
          "wr", "wn", "wb", "wq", "wk", "bn", "wn", "wr", "wp", "wp", "wp",
          "wp", "wp", "wp", "wp", "wp", "no", "no", "no", "no", "no", "no",
          "no", "no", "no", "no", "no", "no", "no", "no", "no", "no", "no",
          "no", "no", "no", "no", "no", "no", "no", "no", "no", "no", "no",
          "no", "no", "no", "no", "bp", "bp", "bp", "bp", "bp", "bp", "bp",
